...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("CarRent Enterprise ");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 310, 500, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\JO\\Documents\\NetBeansProjects\\kelompok projekakhir\\src\\icon\\407.png")); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 500, 340));

        jPanel3.setBackground(new java.awt.Color(25, 118, 211));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Author : Kelompok 8 Nuri Hidayatuloh & Yohan Permana");
        jPanel3.add(jLabel10);

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 420, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, 500, 440));
        ...
        jLabel4.setText("Silahkan Untuk Melakukan Login Terlebih Dahulu");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 190, 420, 440));

        setSize(new java.awt.Dimension(1668, 810));
        ...
        try {
            ...
            if(rs.next()){
                if(rs.getString("hak_akses").equals("admin")){
                    ...
                    ha.show();
                    this.dispose();
                }else if(rs.getString("hak_akses").equals("staff")){
